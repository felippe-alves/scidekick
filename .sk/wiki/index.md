...
| Page | Description |
|---|---|
| [Terminal-Bench 2.0](terminal-bench-2.md) | Long-horizon terminal tasks for agent evaluation |
| [τ-bench](tau-bench.md) | Tool-agent-user interaction benchmark with database state comparison |
| [WebArena](webarena.md) | Realistic web environments for language agents |
| [OSWorld](osworld.md) | Benchmarking multimodal agents in real computer environments |
| [AgentBench](agentbench.md) | Evaluating LLMs as agents across diverse environments |
| [GAIA](gaia.md) | A benchmark for general AI assistants |
| [SolidGoldMagikarp](solidgoldmagikarp.md) | Glitch tokens in LLM vocabularies (Rumbelow & Watkins, 2023) |
...
| [Model Context Protocol](mcp.md) | MCP agent-tool protocol |
...
| [Bun](bun.md) | JavaScript runtime |
| [ripgrep](ripgrep.md) | Embedded search engine |

## Research artifacts

| Page | Description |
|---|---|
| [GPT-5 Harmony Header Leakage](gpt5-harmony-leakage.md) | ERRATA: control-token-masked exfiltration in gpt-5 |
